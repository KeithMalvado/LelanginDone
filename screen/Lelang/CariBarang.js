...
import { View, Text, FlatList, TouchableOpacity, ActivityIndicator, SafeAreaView, Alert, StyleSheet, TextInput } from "react-native";
  ...
  const handleSearch = (text) => {
    ...
    if (text) {
      const filtered = barangList.filter((item) =>
        normalizeString(item.namaBarang).includes(normalizeString(text))
      );
